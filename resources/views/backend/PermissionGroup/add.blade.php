    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-warning">
                ...
                <form id="form" class="form-horizontal" action="{{ Route('backend.permission.group.ajax_add') }}" method="POST">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                @foreach($identity as $k=>$v)
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="identity" value="{{$k}}" class="required" @if($k == 0) checked @endif> {{$v}}
                                        </label>
                                    </div>
                                @endforeach
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="enable" value="0" class="required" > 停用
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="enable" value="1" class="required" checked> 啟用
                                    </label>
                                </div>
                            </div>
                        </div>
